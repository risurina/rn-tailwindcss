# rn-tailwindcss ![Status](https://github.com/risurina/rn-tailwindcss/workflows/test/badge.svg)
...
Initializing `rn-tailwindcss` like that in every file you use it is not convenient.
